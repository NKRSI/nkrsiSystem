...
ROCKET_USERNAME = config.ROCKET_USERNAME
ROCKET_PASSWORD = config.ROCKET_PASSWORD
ROCKET_LOGIN_URL = config.ROCKET_LOGIN_URL
ROCKET_ADD_USER_URL = config.ROCKET_ADD_USER_URL
